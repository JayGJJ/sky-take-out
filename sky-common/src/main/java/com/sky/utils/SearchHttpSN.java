...
//
//        params.put("sn", snCal.caculateSn(params,"/geocoding/v3/?"));
//
...
//    }
    ...
    public String requestGetSN(String strUrl, Map<String, String> param) throws Exception {
        ...
        reader.close();
        isr.close();
        System.out.println("请求结果: " + buffer.toString());
        return buffer.toString();
    }

    public String caculateSn(Map paramsMap,String str,String sk) throws UnsupportedEncodingException,
...
//        paramsMap.put("callback", "showLocation");
        ...
        String wholeStr = new String(str + paramsStr + sk);
